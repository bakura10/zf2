...
ZEPHIR_INIT_CLASS(Zend_ServiceManager_ServiceManager) {
	...
	ZEPHIR_REGISTER_CLASS(Zend\\ServiceManager, ServiceManager, zend, servicemanager_servicemanager, zend_servicemanager_servicemanager_method_entry, 0);
 ...
 * @var array
 */
	zend_declare_property_null(zend_servicemanager_servicemanager_ce, SL("invokables"), ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 * List of factories
 *
 ...
 */
	zend_declare_property_null(zend_servicemanager_servicemanager_ce, SL("factories"), ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 ...
 */
	zend_declare_property_null(zend_servicemanager_servicemanager_ce, SL("abstractFactories"), ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 * List of delegators
 *
 ...
 */
	zend_declare_property_null(zend_servicemanager_servicemanager_ce, SL("delegators"), ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 ...
 */
	zend_declare_property_null(zend_servicemanager_servicemanager_ce, SL("initializers"), ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 * List of aliases
 *
 ...
 * @var array
 */
	zend_declare_property_null(zend_servicemanager_servicemanager_ce, SL("aliases"), ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 * List of shared
 *
 ...
 * @var array
 */
	zend_declare_property_null(zend_servicemanager_servicemanager_ce, SL("shared"), ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 * Set if the instances are shared by default in this service manager
 *
 * @var bool
 */
	zend_declare_property_bool(zend_servicemanager_servicemanager_ce, SL("sharedByDefault"), 1, ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 * List of already created instances
 *
 * @var array
 */
	zend_declare_property_null(zend_servicemanager_servicemanager_ce, SL("instances"), ZEND_ACC_PROTECTED TSRMLS_CC);
...
PHP_METHOD(Zend_ServiceManager_ServiceManager, create) {
	...
	if (!(zend_is_true(instance))) {
		ZEPHIR_INIT_VAR(_0);
		object_init_ex(_0, zend_servicemanager_exception_servicenotfoundexception_ce);
		ZEPHIR_SINIT_VAR(_1);
