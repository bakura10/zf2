 ...
 */
ZEPHIR_INIT_CLASS(Test_ServiceManager_ServiceManagerConfig) {

	ZEPHIR_REGISTER_CLASS(Test\\ServiceManager, ServiceManagerConfig, test, servicemanager_servicemanagerconfig, test_servicemanager_servicemanagerconfig_method_entry, 0);

/**
 * @var array
 */
	zend_declare_property_null(test_servicemanager_servicemanagerconfig_ce, SL("config"), ZEND_ACC_PROTECTED TSRMLS_CC);
 ...
 * @param array config
 */
PHP_METHOD(Test_ServiceManager_ServiceManagerConfig, __construct) {
 ...
 * @return array
 */
PHP_METHOD(Test_ServiceManager_ServiceManagerConfig, getInvokablesConfig) {
 ...
 * @return array
 */
PHP_METHOD(Test_ServiceManager_ServiceManagerConfig, getFactoriesConfig) {
 ...
 * @return array
 */
PHP_METHOD(Test_ServiceManager_ServiceManagerConfig, getAbstractFactoriesConfig) {
 ...
 * @return array
 */
PHP_METHOD(Test_ServiceManager_ServiceManagerConfig, getDelegatorsConfig) {
 ...
 * @return array
 */
PHP_METHOD(Test_ServiceManager_ServiceManagerConfig, getInitializersConfig) {
 ...
 * @return array
 */
PHP_METHOD(Test_ServiceManager_ServiceManagerConfig, getAliasesConfig) {
 ...
 * @return array
 */
PHP_METHOD(Test_ServiceManager_ServiceManagerConfig, getSharedConfig) {
