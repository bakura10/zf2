...
ZEPHIR_INIT_CLASS(Zephir_ServiceManager_ServiceManagerConfig) {
	...
	ZEPHIR_REGISTER_CLASS(Zephir\\ServiceManager, ServiceManagerConfig, zephir, servicemanager_servicemanagerconfig, zephir_servicemanager_servicemanagerconfig_method_entry, 0);

/**
 * @var array
 */
	zend_declare_property_null(zephir_servicemanager_servicemanagerconfig_ce, SL("config"), ZEND_ACC_PROTECTED TSRMLS_CC);
