...
ZEPHIR_INIT_CLASS(Zephir_ServiceManager_ServiceManager) {
	...
	ZEPHIR_REGISTER_CLASS(Zephir\\ServiceManager, ServiceManager, zephir, servicemanager_servicemanager, zephir_servicemanager_servicemanager_method_entry, 0);
 ...
 * @var array
 */
	zend_declare_property_null(zephir_servicemanager_servicemanager_ce, SL("invokables"), ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 * List of factories
 *
 ...
 */
	zend_declare_property_null(zephir_servicemanager_servicemanager_ce, SL("factories"), ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 ...
 */
	zend_declare_property_null(zephir_servicemanager_servicemanager_ce, SL("abstractFactories"), ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 * List of delegators
 *
 ...
 */
	zend_declare_property_null(zephir_servicemanager_servicemanager_ce, SL("delegators"), ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 ...
 */
	zend_declare_property_null(zephir_servicemanager_servicemanager_ce, SL("initializers"), ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 * List of aliases
 *
 ...
 * @var array
 */
	zend_declare_property_null(zephir_servicemanager_servicemanager_ce, SL("aliases"), ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 * List of shared
 *
 ...
 * @var array
 */
	zend_declare_property_null(zephir_servicemanager_servicemanager_ce, SL("shared"), ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 * Set if the instances are shared by default in this service manager
 *
 * @var bool
 */
	zend_declare_property_bool(zephir_servicemanager_servicemanager_ce, SL("sharedByDefault"), 1, ZEND_ACC_PROTECTED TSRMLS_CC);
/**
 * List of already created instances
 *
 * @var array
 */
	zend_declare_property_null(zephir_servicemanager_servicemanager_ce, SL("instances"), ZEND_ACC_PROTECTED TSRMLS_CC);
...
PHP_METHOD(Zephir_ServiceManager_ServiceManager, __construct) {
	...
	zval *config = NULL, *_0, *_1, *_2, *_3, *_4, *_5, *_6, *_7;
	...
	ZEPHIR_INIT_VAR(_1);
	array_init(_1);
	zephir_update_property_this(this_ptr, SL("factories"), _1 TSRMLS_CC);
	ZEPHIR_INIT_VAR(_2);
	array_init(_2);
	zephir_update_property_this(this_ptr, SL("abstractFactories"), _2 TSRMLS_CC);
	ZEPHIR_INIT_VAR(_3);
	array_init(_3);
	zephir_update_property_this(this_ptr, SL("delegators"), _3 TSRMLS_CC);
	ZEPHIR_INIT_VAR(_4);
	array_init(_4);
	zephir_update_property_this(this_ptr, SL("initializers"), _4 TSRMLS_CC);
	ZEPHIR_INIT_VAR(_5);
	array_init(_5);
	zephir_update_property_this(this_ptr, SL("aliases"), _5 TSRMLS_CC);
	ZEPHIR_INIT_VAR(_6);
	array_init(_6);
	zephir_update_property_this(this_ptr, SL("shared"), _6 TSRMLS_CC);
	ZEPHIR_INIT_VAR(_7);
	array_init(_7);
	zephir_update_property_this(this_ptr, SL("instances"), _7 TSRMLS_CC);
...
PHP_METHOD(Zephir_ServiceManager_ServiceManager, addInvokables) {
	...
	ZEPHIR_INIT_VAR(_0);
	_1 = zephir_fetch_nproperty_this(this_ptr, SL("invokables"), PH_NOISY_CC);
...
PHP_METHOD(Zephir_ServiceManager_ServiceManager, setInvokables) {
	...
	array_init(_0);
	zephir_update_property_this(this_ptr, SL("invokables"), _0 TSRMLS_CC);
	zephir_call_method_p1_noret(this_ptr, "addinvokables", config);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Zephir_ServiceManager_ServiceManager, addFactories) {
	...
	ZEPHIR_INIT_VAR(_0);
	_1 = zephir_fetch_nproperty_this(this_ptr, SL("factories"), PH_NOISY_CC);
	zephir_fast_array_merge(_0, &(_1), &(config) TSRMLS_CC);
...
PHP_METHOD(Zephir_ServiceManager_ServiceManager, addAbstractFactories) {
	...
	for (
		...
		if ((Z_TYPE_P(abstractFactory) == IS_STRING)) {
			ZEPHIR_INIT_NVAR(abstractFactory);
			_3 = zend_fetch_class(SL("abstractFactory"), ZEND_FETCH_CLASS_AUTO TSRMLS_CC);
			object_init_ex(abstractFactory, _3);
		}
		zephir_array_append(&abstractFactories, abstractFactory, PH_SEPARATE);
	}
	ZEPHIR_INIT_VAR(_4);
	_5 = zephir_fetch_nproperty_this(this_ptr, SL("abstractFactories"), PH_NOISY_CC);
...
PHP_METHOD(Zephir_ServiceManager_ServiceManager, addDelegators) {
	...
	ZEPHIR_INIT_VAR(_0);
	_1 = zephir_fetch_nproperty_this(this_ptr, SL("delegators"), PH_NOISY_CC);
	zephir_fast_array_merge(_0, &(_1), &(config) TSRMLS_CC);
...
PHP_METHOD(Zephir_ServiceManager_ServiceManager, addInitializers) {
	...
	for (
		...
		if ((Z_TYPE_P(initializer) == IS_STRING)) {
			ZEPHIR_INIT_NVAR(initializer);
			_3 = zend_fetch_class(SL("initializer"), ZEND_FETCH_CLASS_AUTO TSRMLS_CC);
			object_init_ex(initializer, _3);
		}
		zephir_array_append(&initializers, initializer, PH_SEPARATE);
	}
	ZEPHIR_INIT_VAR(_4);
	_5 = zephir_fetch_nproperty_this(this_ptr, SL("initializers"), PH_NOISY_CC);
...
PHP_METHOD(Zephir_ServiceManager_ServiceManager, addShared) {
	...
	ZEPHIR_INIT_VAR(_0);
	_1 = zephir_fetch_nproperty_this(this_ptr, SL("shared"), PH_NOISY_CC);
	zephir_fast_array_merge(_0, &(_1), &(config) TSRMLS_CC);
...
PHP_METHOD(Zephir_ServiceManager_ServiceManager, get) {
	...
	zval *name = NULL, *creationOptions = NULL, *shared = NULL, *sharedInstances, *instances, *instance, *_0;
	...
	if (!(zephir_array_isset_fetch(&shared, sharedInstances, name))) {
		ZEPHIR_OBS_NVAR(shared);
		zephir_read_property_this(&shared, this_ptr, SL("sharedByDefault"), PH_NOISY_CC);
	}
	...
	if (zend_is_true(shared)) {
		zephir_array_update_zval(&instances, name, &instance, PH_COPY | PH_SEPARATE);
	}
...
PHP_METHOD(Zephir_ServiceManager_ServiceManager, resolveAlias) {
	...
	while (1) {
		...
		zephir_array_fetch(&name, aliases, name, PH_NOISY TSRMLS_CC);
	}
	RETURN_CCTOR(name);
...
PHP_METHOD(Zephir_ServiceManager_ServiceManager, create) {
	...
	HashTable *_4;
	HashPosition _3;
	zval *name, *creationOptions = NULL, *instance, *invokables, *factories, *initializers, *_0 = NULL, _1, *_2, *initializer = NULL, **_5;
	...
	if (zephir_array_isset(invokables, name)) {
		...
		ZEPHIR_INIT_BNVAR(instance);
		if (zephir_array_isset(factories, name)) {
			zephir_call_method_p2(instance, this_ptr, "createfromfactory", name, creationOptions);
		} else {
	...
	if (!(zend_is_true(instance))) {
		ZEPHIR_INIT_VAR(_0);
		object_init_ex(_0, zephir_servicemanager_exception_servicenotfoundexception_ce);
		ZEPHIR_SINIT_VAR(_1);
	...
	for (
		...
		if (zephir_is_instance_of(initializer, SL("initializerinterface") TSRMLS_CC)) {
			zephir_call_method_p2_noret(initializer, "initialize", instance, this_ptr);
		}
		if (zephir_is_callable(initializer TSRMLS_CC)) {
			ZEPHIR_INIT_NVAR(_0);
			array_init(_0);
			zephir_array_append(&_0, instance, 0);
			zephir_array_append(&_0, this_ptr, 0);
			zephir_call_func_p2_noret("call_user_func_array", initializer, _0);
		}
	}
	RETURN_CCTOR(instance);
...
PHP_METHOD(Zephir_ServiceManager_ServiceManager, createFromInvokable) {
	...
	zephir_array_fetch(&invokableClass, invokables, name, PH_NOISY TSRMLS_CC);
...
PHP_METHOD(Zephir_ServiceManager_ServiceManager, createFromFactory) {
	...
	zend_class_entry *_0;
	zval *name, *creationOptions = NULL, *factories, *factory;
	...
	zephir_array_fetch(&factory, factories, name, PH_NOISY TSRMLS_CC);
	if ((Z_TYPE_P(factory) == IS_STRING)) {
		ZEPHIR_INIT_BNVAR(factory);
		_0 = zend_fetch_class(SL("factory"), ZEND_FETCH_CLASS_AUTO TSRMLS_CC);
		object_init_ex(factory, _0);
		zephir_update_property_array(this_ptr, SL("factories"), name, factory TSRMLS_CC);
	}
	if (zephir_is_instance_of(factory, SL("factoryinterface") TSRMLS_CC)) {
		zephir_call_method_p2(return_value, factory, "createservice", this_ptr, creationOptions);
		RETURN_MM();
	}
