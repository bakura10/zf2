...
class ServiceManager implements ServiceLocatorInterface
{
    ...
    public function addAbstractFactories(config)
    {
        ...
        for abstractFactory in config {
            if typeof abstractFactory == "string" {
    ...
    {
        var shared, sharedInstances, instances, instance;
        ...
        if !fetch shared, sharedInstances[name] {
            let shared = this->sharedByDefault;
        }
    ...
    public function create(name, creationOptions = null)
    {
        ...
        if !instance {
            throw new Zephir\ServiceManager\Exception\ServiceNotFoundException(sprintf(
        ...
        for initializer in initializers {
            ...
            if is_callable(initializer) {
                call_user_func_array(initializer, [instance, this]);
            }
        }
